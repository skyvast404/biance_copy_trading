...
Usage:
    python main_futures.py [--config CONFIG_FILE]

Configuration:
    Copy config.futures.example.yaml to config.yaml and fill in your API credentials.
"""
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python main_futures.py                    # Use default config.yaml
  python main_futures.py --config my.yaml   # Use custom config file

For more information, see README_FUTURES.md
        """
    )
...
def main():
    ...
    try:
        ...
        print("  1. Copy config.futures.example.yaml to config.yaml")
